...
class personpage(object):
    def __init__(self, master=None,personq=0):
        ...
        onlyuse = np.loadtxt('data/'+self.stryear+self.strmonth+'-face.csv', dtype=np.str,delimiter=',',usecols=(0,1,2,3,4,5,0,1) )
    ...
    def month_callbackFunc(self,personq):
        ...
        #try:
        onlyuse = np.loadtxt('data/'+callbackmonth[0]+backmonth+'-face.csv',dtype=np.str,delimiter=',',usecols=(0,1,2,3,4,5,0,1))
        print(onlyuse)
