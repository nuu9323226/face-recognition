        ...
        for dpart in dpartment:
            ...
            if len(gpart)<7:
                ...
                for personq in gpart:
                    ...
                    locals()['self.textLabel'+str(personq)] = tk.Label(self.page,textvariable=locals()['self.var'+str(personq)], font=('微軟正黑體', 12),justify = tk.LEFT)
...
class personpage(object):
    ...
    def show_idcard_callbackFunc(self,personq):
        ...
        try:
            onlyuse = np.loadtxt('datas/'+personq+'/'+personq+'-'+callbackmonth[0]+backmonth+'-idcard.csv',dtype=np.str,delimiter=',',usecols=(0,1,2,3,4,5))
            print(onlyuse)
