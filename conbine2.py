...
import queue
import chardet
#update release 2019/12/23

q = queue.Queue(maxsize = 100)
#qi = queue.PriorityQueue(maxsize = 100)
#stim = queue.Queue(maxsize = 1)
...
pi=threading.Thread(target=reflesh,args=())
pi.start()
