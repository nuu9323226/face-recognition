...
class personpage(object):
    def __init__(self, master=None,personq=0):
        ...
        onlyuse = np.loadtxt('data/'+self.stryear+self.strmonth+'-face.csv',encoding = 'utf-8',dtype=np.str,delimiter=',',usecols=(0,1,2,3,4,5,0,1) )
        ...
        if len(glob.glob('data/'+self.personq+'-'+self.stryear+self.strmonth+'-personal.csv'))>=1 :
            ...
            onlyRemote = np.loadtxt('data/'+self.personq+'-'+self.stryear+self.strmonth+'-personal.csv',encoding = 'utf-8',dtype=np.str,delimiter=',',usecols=(0,1,2,3,4,5,6,7))
