...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        #HumanNames = ['020401_Ken_756','020406_James_756','040605_Rick_705','051101_Jacky_330','060601_Iona_560',
         #             '870202_R4Lai_570','900211_Carol_301','930909_Mandy_530','a1_Allen','a2_Bryan',
          #            'a3_David_760','a4_Diego','a5_Forbes','a6_Kelin','a7_Mark',
           #           'a8_Sam','a9_Vado','b1_Vincent','b4_Jerry_756','b7_Stanley_325',
            #          'b8_Willy_308','b9_Eson_756','c2_Jackie_283','c3_Kay_756','c4_Vinie_120']
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        try:
                            ...
                            elif np.max(predictions[0]) < predictionMax and np.max(predictions[0]) > predictionMin:
                                put_text = '{name} {confidence: 3.2f}'.format(name = HumanNames[best_class_indices[0]], confidence = (np.max(predictions[0]).tolist())*100)
